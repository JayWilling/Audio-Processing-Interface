...
class Analysis_frame:
    ...
    def initUI(self):
        ...
        self.file_location.insert(0, 'audio/recordings/cmajorscale-piano.wav')
        ...
        self.val_btn = Button(master=self.parent, text="Validate", command=self.validate_models)
    ...
    def analyse_file(self):
        ...
        ** Embed matplotlib in tkinter GUI **
        ...
        analysis.draw_single_performance_feedback(feedback_frame, utils.get_performance_record(self.file_location.get()))
